...
function dePalabrasAFrase(palabras) {
   ...
   // Tu código:
   var palabra_concatenada = palabras.join(" ");
...
function cuentoElementos(array) {
   ...
   // Tu código:
   var cont_mayor_valor = 0;
   for (var i = 0; i < array.length; i++) {
      if (array[i] > 18) {
         cont_mayor_valor += 1;
      }
   }
   return cont_mayor_valor;
}
...
function tablaDelSeis() {
   ...
   // Tu código:
   var tabla_multpiplicar = [];
   for (var i = 0; i < 11; i++) {
      tabla_multpiplicar.push(6 * i);
   }
   return tabla_multpiplicar;
}
